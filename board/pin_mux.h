...
#define BOARD_INITPINS_TSL2591_SCL_PERIPHERAL                             LPI2C4   /*!< Peripheral name */
#define BOARD_INITPINS_TSL2591_SCL_SIGNAL                                    SCL   /*!< Signal name */

/* GPIO_SD_B1_03 (number 28), I2C4_SDA */
/* Routed pin properties */
#define BOARD_INITPINS_TSL2591_SDA_PERIPHERAL                             LPI2C4   /*!< Peripheral name */
#define BOARD_INITPINS_TSL2591_SDA_SIGNAL                                    SDA   /*!< Signal name */

/* GPIO_AD_B1_14 (number 75), I2C1_SCL/U10[17]/J18[6] */
/* Routed pin properties */
#define BOARD_INITPINS_HT16K33_SCL_PERIPHERAL                             LPI2C1   /*!< Peripheral name */
#define BOARD_INITPINS_HT16K33_SCL_SIGNAL                                    SCL   /*!< Signal name */

/* GPIO_AD_B1_15 (number 74), I2C1_SDA/U10[18]/J18[5] */
/* Routed pin properties */
#define BOARD_INITPINS_HT16K33_SDA_PERIPHERAL                             LPI2C1   /*!< Peripheral name */
#define BOARD_INITPINS_HT16K33_SDA_SIGNAL                                    SDA   /*!< Signal name */
...
/* Routed pin properties */
#define BOARD_INITPINS_SD_CD_SW_PERIPHERAL                                 GPIO3   /*!< Peripheral name */
#define BOARD_INITPINS_SD_CD_SW_SIGNAL                                   gpio_io   /*!< Signal name */
#define BOARD_INITPINS_SD_CD_SW_CHANNEL                                      19U   /*!< Signal channel */

/* Symbols to be used with GPIO driver */
#define BOARD_INITPINS_SD_CD_SW_GPIO                                       GPIO3   /*!< GPIO peripheral base pointer */
#define BOARD_INITPINS_SD_CD_SW_GPIO_PIN                                     19U   /*!< GPIO pin number */
#define BOARD_INITPINS_SD_CD_SW_GPIO_PIN_MASK                        (1U << 19U)   /*!< GPIO pin mask */
#define BOARD_INITPINS_SD_CD_SW_PORT                                       GPIO3   /*!< PORT peripheral base pointer */
#define BOARD_INITPINS_SD_CD_SW_PIN                                          19U   /*!< PORT pin number */
#define BOARD_INITPINS_SD_CD_SW_PIN_MASK                             (1U << 19U)   /*!< PORT pin mask */
